...
#import skip_torch_lstm
from skip_lstm import skip_torchlstm_cell_
...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, etype, idim, elayers, eunits, eprojs, subsample, dropout, in_channel=1):
        ...
        if etype == 'blstm':
            ...
            self.enc1 = BLSTMP(idim, elayers, eunits, eprojs, dropout)
...
# its the skip rnn. But to make things easeir, does not change its name
class BLSTM(torch.nn.Module):
    # make is suitable for ESPnet
    def __init__(self, idim, elayers, cdim, hdim, dropout):
        super(BLSTM, self).__init__()
        self.cdim = cdim
        self.skip_lstm = skip_torchlstm_cell_(idim, cdim, elayers, batch_first=True,
